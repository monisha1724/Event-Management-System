...
//properties.put("mail.smtp.socketFactory.fallback", "false");
    String myAccountEmail = "event._s._planner@outlook.com";
 ...
 private static Message prepareMessage(Session session, String myAccountEmail, String recepient,String str){
    try{
        ...
        message.setSubject("Confirmation Mail for Event Booking");
        String htmlCode = "<h3> We have Received the request for Booking an event  </h3> <br>Our Event Manager will Contact you Shortly! <br><br><br><br> Thanks & Regards <br> Signature Soire`es";
 ...
 public static void main(String[] args) throws Exception {  
                 ...
                 sendMail("event._s._planner@outlook.com","Your Booking Has Been Confirmed");
