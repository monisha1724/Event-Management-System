...
//properties.put("mail.smtp.socketFactory.fallback", "false");
 ...
 private static Message prepareMessage(Session session, String myAccountEmail, String recepient,String str){
    try{
        ...
        String htmlCode = "<h3> WE HAVE RECEIVE A REQUEST FOR FORGOT PASSWORD  </h3> <br>SIGN IN USING THIS NEW PASSWORD AND UPDATE IT LATER :" + str+"<br><br><br><br> Thanks & Regards <br> Signature Soire`es";
